...
@WebServlet(name = "AdminEventUnlockServlet", urlPatterns = {"/AdminEventUnlockServlet"})
public class AdminEventUnlockServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.printStackTrace();
            response.sendRedirect(request.getContextPath() + "/AdminEventsServlet?unlockError=true");
        }
    }
}
