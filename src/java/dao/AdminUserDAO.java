...
public class AdminUserDAO {
    ...
    /**
     * Returns an user according to the inputted id . This method is used to
     * view list of users and their basic information.
     *
     * @param id The inputted id to specify which user to get from the database.
     * @return The id-specified user and their other information such as account
     * id, role, username, full name, gender and avatar.
     */
    ...
    /**
     * Get a list of all current user from the database. This method gives a
     * list of all user while also showing more details about them.
     *
     * @return The list of all users and their details including id, role,
     * username, full name, gender, phone, email, address, avatar, job, bio and
     * date of birth.
     */
    ...
    /**
     * The method used to update user detail as an admin.The method will take in
    ...
    /**
     * Quite the same as getUserById, this method gets user by id, but with even
     * more details.
     *
    ...
    /**
     * Get a list of all user and their basic information, now with pagination
     * logic.
     *
    ...
    /**
     * This method will get the count of all current users in the database. Used
     * to evaluate the number of pages.
     *
    ...
    /**
     * A method that gets a list of all user, with pagination logic while also
     * handling the filter.
     *
     * @param page Page number.
     * @param pageSize The number of users per page.
     * @param role Get the inputted role for filtering by role.
     * @param search Get the inputted search string for searching with full
     * name.
