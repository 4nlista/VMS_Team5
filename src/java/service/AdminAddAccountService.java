...
public class AdminAddAccountService {
    ...
    /**
     * Result class to hold the result of account creation
     */
    ...
    /**
     * Upload avatar file and return the filename (not full path)
     * File được lưu vào thư mục cố định bên ngoài webapp để tránh mất khi deploy
     ...
     * @return Array with [InputStream, fileName] or [null, null] if no valid avatar
     */
    ...
    /**
     * Main method to create organization account with all details
     * This method handles all business logic including avatar processing
     ...
     * @return CreateAccountResult with success status and error message if failed
     */
    public CreateAccountResult createOrganizationAccount(
        ...
        boolean userCreated = userDAO.insertUser(accountId, fullName, email, phone, 
