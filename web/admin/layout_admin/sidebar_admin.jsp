    ...
    <ul class="nav flex-column mb-auto">
        ...
        <li>
            <a href="<%= request.getContextPath() %>/AdminAccountServlet"
               class="nav-link text-white <%= (currentPath.endsWith("/AdminAccountServlet") || currentPath.endsWith("/admin/accounts_admin.jsp") || currentPath.endsWith("/accounts_admin.jsp") || currentPath.endsWith("/admin/detail_accounts_admin.jsp") || currentPath.endsWith("/detail_accounts_admin.jsp")) ? "active" : "" %>">
