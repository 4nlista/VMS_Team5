                                    ...
                                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-1">
                                                ...
                                                <span class="h1 fw-bold mb-0">Đăng kí tài khoản</span>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="form2Example17">Email</label>
                                                <input type="emaill" name="email" id="form2Example17" class="form-control form-control-lg border rounded px-2 py-1" />
                                            </div>
                                            ...
                                            <div class="pt-1 mb-4">
                                                <button class="btn btn-danger btn-lg btn-block" type="submit">Đăng kí tài khoản</button>
                                            </div>
