<%-- 
    Document   : detail_history_payment_volunteer
    Created on : Nov 15, 2025, 10:25:09 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container mt-5 pt-5 pb-5">
            <h1 class="mb-4 text-center text-primary fw-bold">Chi tiết thanh toán</h1>

            <c:choose>
                <c:when test="${empty donation}">
                    <div class="alert alert-danger text-center">
                        <i class="bi bi-exclamation-triangle"></i> Không tìm thấy thông tin thanh toán.
                    </div>
