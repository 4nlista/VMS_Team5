<%-- 
    Document   : notification_org
    Created on : Nov 13, 2025, 10:19:31 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Thông báo - Organization</title>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <c:if test="${not empty notifications}">
                                <form method="POST" action="<%= request.getContextPath() %>/OrganizationNotificationServlet" style="display: inline;">
                                    ...
                                    <div class="list-group-item notification-item ${noti.isRead ? '' : 'unread'} mb-3 rounded shadow-sm">
                                        <div class="d-flex w-100 justify-content-between align-items-start">
                                            ...
                                            <c:if test="${!noti.isRead}">
                                                <form method="POST" action="<%= request.getContextPath() %>/OrganizationNotificationServlet" class="ms-3">
