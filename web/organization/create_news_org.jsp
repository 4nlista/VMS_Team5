                        ...
                        <form action="${pageContext.request.contextPath}/OrganizationNewsCreate"
                            ...
                            <div class="col-12">
                                ...
                                <div class="border p-2 text-center mb-4"
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty newsInput.images}">
                                            <img id="preview"
                                                 src="${pageContext.request.contextPath}/NewsImage?file=${newsInput.images}"
                                ...
                                <!-- NOTE: input name MUST match servlet getPart("newsImage") -->
                                <input type="file" class="form-control" name="newsImage" accept="image/*" onchange="previewImage(event)">
