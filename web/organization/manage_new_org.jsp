        ...
        <div class="content-container d-flex">
            ...
            <div class="main-content p-4 flex-grow-1">
                <div class="container" style="max-width: 1000px;">
                    ...
                    <!-- Bộ lọc + nút tạo mới -->
                    <form method="get" action="${pageContext.request.contextPath}/OrganizationManageNews"
                          class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                        <div class="d-flex gap-2 align-items-end flex-wrap">
                            <!-- Tìm kiếm -->
                            <div class="form-group d-flex flex-column">
                                <label class="form-label fw-semibold">Tìm kiếm</label>
                                <input type="text" name="search" class="form-control form-control-sm" style="width: 200px;" value="${currentSearch}" placeholder="Tìm tiêu đề...">
                            </div>
                            <!-- Trạng thái -->
                            <div class="form-group d-flex flex-column">
                            ...
                            <!-- Nút Reset -->
                            <a href="${pageContext.request.contextPath}/OrganizationManageNews" class="btn btn-secondary btn-sm" style="min-width:100px;">
                                <i class="bi bi-arrow-counterclockwise"></i> Reset
                            </a>
                        </div>
                        <!-- Nút tạo mới bài viết -->
                        <a href="${pageContext.request.contextPath}/OrganizationNewsCreate"
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                            ...
                            <nav aria-label="User list pagination">
                                <ul class="pagination mb-0 flex-wrap justify-content-center">
                                    <!-- Previous -->
                                    <c:url var="prevUrl" value="${pageContext.request.contextPath}/OrganizationManageNews">
                                    ...
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <c:url var="pageUrl" value="${pageContext.request.contextPath}/OrganizationManageNews">
                                    ...
                                    <!-- Next -->
                                    <c:url var="nextUrl" value="${pageContext.request.contextPath}/OrganizationManageNews">
                                        <c:param name="page" value="${currentPage + 1}" />
                                        <c:param name="status" value="${fn:escapeXml(currentStatus)}" />
                                        <c:param name="search" value="${fn:escapeXml(currentSearch)}" />
                                    </c:url>
                            ...
                            <!-- Right: Go to page -->
                            <form action="${pageContext.request.contextPath}/OrganizationManageNews" method="get" class="d-flex align-items-center gap-2">
