...
<div class="content-container">
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li>
                <a href="<%= request.getContextPath() %>/ManageApplicationsServlet"
                   class="nav-link text-white <%= currentPath.endsWith("/ManageApplicationsServlet") ? "active" : "" %>">
                    <i class="bi bi-person-lines-fill me-2"></i>
                    Quản lí người dùng
                </a>
            </li>
            <li>
                <a href="<%= request.getContextPath() %>/OrganizationEventServlet"
                   class="nav-link text-white <%= currentPath.endsWith("/OrganizationEventServlet") ? "active" : "" %>">
