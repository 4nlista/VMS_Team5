<%-- Document : home_org Created on : Sep 7, 2025, 4:14:28 PM Author : Organization --%>
                ...
                <body>
                    <div class="content-container">
                        ...
                        <div class="main-content" style="background-color:#f8f9fa; padding:20px;">
                            <!-- Thanh tiêu đề -->
                            <div
                                class="topbar d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="card border rounded shadow-sm p-3 bg-white">
                                        <h6 class="fw-bold mb-3"><i class="bi bi-trophy"></i> Top 3 sự kiện được tài trợ
                                            nhiều nhất</h6>
                                        <c:choose>
                                                        ...
                                                        <c:forEach var="e" items="${topEvents}" varStatus="status">
                                                            <tr>
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${status.index == 0}">
                                                                            <span
                                                                                class="badge bg-warning text-dark">no1.</span>
                                                                        </c:when>
                                                                ...
                                                                <td class="text-end fw-bold">
                                                                    <fmt:formatNumber value="${e.totalDonation}"
                                                                        type="number" pattern="#,###" />
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="d" items="${topDonors}" varStatus="status">
                                                            <tr>
                                                                ...
                                                                <td>${d.fullName}</td>
                                                                <td class="text-end fw-bold">
                                                                    <fmt:formatNumber value="${d.totalDonated}"
                                                                        type="number" pattern="#,###" />
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                            ...
                            <div class="card border rounded shadow-sm p-3 bg-white mt-4 mb-4">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <table
                                            class="table table-striped table-sm table-bordered table-hover align-middle">
                                            <thead class="table-light">
                                                <tr>
                                                    <th>STT</th>
                                                    <th>Tên sự kiện</th>
                                            ...
                                            <tbody>
                                                <c:forEach var="e" items="${upcomingEvents}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>${e.title}</td>
                                                        <td>
                                                            <fmt:formatDate value="${e.startDate}"
                                                                pattern="dd/MM/yyyy" />
                                                        </td>
                                                        <td>
                                                            <fmt:formatDate value="${e.endDate}" pattern="dd/MM/yyyy" />
                                                        </td>
                                                        <td>${e.location}</td>
