            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                        <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr"><a href="index.jsp">Home</a></span></p>
                    ...
                    <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 color-2 align-items-stretch">
                            <div class="text">
                                ...
                                <p><a href="${pageContext.request.contextPath}/ActionRedirectServlet?action=donate" class="btn btn-white px-3 py-2 mt-2">Đăng kí tài trợ</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 color-3 align-items-stretch">
                            <div class="text">
                                ...
                                <p>Even the all-powerful Pointing has no control about the blind texts.</p>
                                <p><a "${pageContext.request.contextPath}/ActionRedirectServlet?action=volunteer" class="btn btn-white px-3 py-2 mt-2">Đăng kí tham gia</a></p>
                            </div>
                        </div>
                    </div>
                </div>
